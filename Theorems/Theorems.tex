...
\begin{theorem}
    ...
    \begin{itemize}
        ...
        \item $K\subset B$ is closed if and only if $f^{-1}(K)$ is closed.
    \end{itemize}
\end{theorem}
...
\end{theorem}
    \noindent
    \textbf{Proof.} It suffices to show that $f^{-1}$ is continuous. Let $A\subset X$ be an open set. Let $y\in f(A)$. 
