...
\begin{definition}[Group Representation]
    Let $G$ be a group and $V$ be a vector space over $\mathbb{C}$. A \textit{group representation} of $G$ in $V$ is a group homomorphism $\rho:G\rightarrow GL(V)$ from $G$ to the general linear group on $V$.
\end{definition}
