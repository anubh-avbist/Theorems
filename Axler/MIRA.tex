...
\newline
\newline
Let $a=x_0,...,x_n=b$ denote the partition $P$ of $[a,b]$. Since the lower and upper Riemann sums are equal, we have
\begin{align*}
...
\newline
\newline
Recall that the infimum of the set of sums of two sets of real numbers is at least the sum of the infimum of the two sets. Then, we have
\begin{align*}
