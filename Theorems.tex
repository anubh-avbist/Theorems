...
\begin{definition}[Cover]
    Let $X$ be a set, and $B=\{U_i\}$ be a collection of sets. $B$ is called a \textit{cover} of $X$ if $X\subset \bigcup \limits_{i}U_i$.
\end{definition}


\begin{definition}[Relation]
    Let $A$ be a set. A \textit{relation} $R$ on $A$ is a subset $R\subset A\times A$. For each $x,y\in A$, we denote $xRy \iff (x,y)\in R$. 
\end{definition}
\begin{definition}[Transitive Relation]
    Let $R$ be a relation on a set $A$. $R$ is called \textit{transitive} if, for each $x,y,z\in A$, if $xRy$ and $yRz$, then $xRz$.   
\end{definition}
\begin{definition}[Symmetric Relation]
    Let $R$ be a relation on a set $A$. $R$ is called \textit{symmetric} if, for each $x,y\in A$, if $xRy$, then $yRx$.   
\end{definition}
\begin{definition}[Reflexive Relation]
    Let $R$ be a relation on a set $A$. $R$ is called \textit{reflexive} if, for each $x\in A$, if $xRx$.   
\end{definition}
\begin{definition}[Equivalence Relation]
    Let $R$ be a relation on a set $A$. $R$ is called an \textit{equivalence relation} if it is transitive, symmetric, and reflexive.
\end{definition}
\begin{definition}[Equivalence Class]
    Let $R$ be an equivalence relation on a set $A$, and $a\in A$. The set $[a]=\{x\in A:xRa\}$ is called the \textit{equivalence class} of $a$.
\end{definition}
